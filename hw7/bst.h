...
public:
    ...
    protected:
        ...
        Node<Key, Value>* nextLargest(Node<Key, Value>* ptr);
    };
    //--------------------------------------------------------------------------------//
public:
...
{
    // TODO
    // default constructor, let the mCurrent be the root node.
    mCurrent = this->mRoot;
}
...
{
    // TODO
    Node<Key, Value>* ptr = nextLargest(this->mCurrent);
    this->mCurrent = ptr;
    return *this; // A dummy return value until you provide your implementation.
}

template<typename Key, typename Value>
Node<Key, Value>* BinarySearchTree<Key, Value>::iterator::nextLargest(Node<Key, Value>* ptr){
...
typename BinarySearchTree<Key, Value>::iterator BinarySearchTree<Key, Value>::begin()
{
    ...
    Node<Key,Value>* ptr = this->mRoot;
    while (ptr->getLeft() != NULL) {
        ptr = ptr->getLeft();
    }
    return iterator(ptr); // A dummy return value until you provide your implementation.
}
...
//    }
    ...
    //return iterator(ptr->getRight()); // A dummy return value until you provide your implementation.
    return NULL;
}
...
{
    // TODO
    Node<Key,Value>* ptr = internalFind(key);
